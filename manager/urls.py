...
from manager import views_dish, views_menu, views_kitchen, views_test
...
urlpatterns = [
    ...
    url('api/dish/search_type', views_dish.search_type),
    ...
    url('api/kitchen/(?P<pk>\d+)', views_kitchen.kitchendetailView.as_view()),
    ...
    url('api/kitchen/order_type', views_kitchen.order_type.as_view()),
